...
//Boilerplate code to prevent any redirect errors
ourApp.use(express.urlencoded({extended: false}))

ourApp.get('/', function(req, res){
//Reading data from the database. Collection is a method or a list.
    ...
    <body>
      <div class="container">
        ...
        <ul class="list-group pb-5">
          ${items.map(function(item/*name doesnt matter*/){
